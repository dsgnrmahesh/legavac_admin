...
import { getCourseDetail, getCourseDelete } from "../config/api";
import { Col } from "react-bootstrap";
import { mdiPencilOutline, mdiTrashCanOutline } from "@mdi/js";
import Icon from "@mdi/react";
export default function ManageCourse({ handleAddNew, handleEdit }) {
                ...
                <li key={index}>
                  <span className="d-flex">
                    ...
                    <label className="bxName">
                      {item.CourseName} | {item.EducationName}
                    </label>
                  </span>
                  <span className="d-flex">
                    <button
                    ...
                    <button
                      ...
                      onClick={() => DeleteData(item.CourseID)}
                    >
